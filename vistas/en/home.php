		...
		<div class="container border">
			<div class="row border"> 
				...
				<div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 wow fadeInRight">  
					<h3 align="center" class="mr-5 ml-5"  > 
						¿Quienes Somos? 
					</h3> 		
					<p align="center"  > AlsuveTech es un equipo conformado por dos jovenes ingenieros freelance enfocados en el diseño de páginas Web para ofrecer servicios personalizados de alta calidad de acuerdo a las necesidades de nuestros clientes.
					</p> 
					<p align="center" > Nuestra empresa ofrece tecnología HTML5 Animado y PHP en la página web, haciendo que su sitio en Internet sea mas dinámico y llamativo, distinto a los tradicionales sitios sin animación; todo esto junto a un estupendo diseño grafico.
					</p> 
				</div>
			</div>
		</div>
		...
		<div class="container fadeInUpBig" >
		 	<div class="row justify-content-around"> 
				<div class="col-12 col-sm-12 col-md-12 col-lg-3 col-xl-3 ml-4 wow fadeInUpBig" data-wow-delay="1s"> 
	        		...
	        		<br>
	        		<p align="center" > Crea junto a nosostros una web profesional avanzada para aumentar el prestigio de tu marca
					</p>
	    		</div>
				...
				<div class="col-12 col-sm-12 col-md-12 col-lg-3 col-xl-3 ml-4 wow fadeInUpBig" data-wow-delay="1.5s">
	        		...
	        		<br>
					<p align="center" > Aplicamos SEO a tu pagina para que tenga un posicionamiento y tu marca cresca efectivamente
					</p>
				</div>
				...
				<div class="col-12 col-sm-12 col-md-12 col-lg-3 col-xl-3 ml-4 wow fadeInUpBig" data-wow-delay="2s">
	        		...
	        		<br>
					<p align="center" > Si no sabes como crear tu pagina nosotros te ayudamos, planteanos tus dudas!
					</p>
